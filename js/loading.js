...
(function () {
  const DISPLAY_MS = 4000; // how long the splash stays up before the page shows
  const FADE_MS = 450;
  ...
  // Fixed, predictable duration — the page underneath (e.g. the
  // login form) is already done rendering almost instantly, so
  // tying this to the 'load' event made the splash disappear
  // after ~1s, easy to miss entirely. This always shows for a
  // full DISPLAY_MS before revealing the page beneath it.
  function dismiss() {
